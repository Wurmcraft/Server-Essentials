...
The Rank module is a module designed to protect the server from malicious actors, such as unauthorized players getting
admin perks or joining with forbidden client mods.
