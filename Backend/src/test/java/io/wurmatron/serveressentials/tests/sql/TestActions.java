...
public class TestActions {
  ...
  public static final Action TEST_ACTION =
      new Action(
  ...
  public void testUpdateAction() {
    ...
    boolean found = false;
    for (Action a : actions)
      if (a.action_data.equals(TestActions.TEST_ACTION.action_data)) found = true;
  ...
  public void testDeleteAction() {
    Action deletedAction =
        SQLActions.delete(
            TEST_ACTION.host, TEST_ACTION.action, TEST_ACTION.related_id, TEST_ACTION.timestamp);
