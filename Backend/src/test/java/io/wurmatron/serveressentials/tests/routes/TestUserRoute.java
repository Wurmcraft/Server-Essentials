...
public class TestUserRoute {
  ...
  public void testAddUser() throws IOException {
    Account createdAccount =
        HTTPRequests.postWithReturn("api/user", TestAccounts.TEST_ACCOUNT, Account.class);
  ...
  public void testGetUsername() throws IOException {
    String username =
        HTTPRequests.get("api/user/" + TestAccounts.TEST_ACCOUNT.uuid + "/username", Account.class)
            .username;
  ...
  public void testGetRanks() throws IOException {
    String[] ranks =
        HTTPRequests.get("api/user/" + TestAccounts.TEST_ACCOUNT.uuid + "/rank", Account.class)
            .rank;
  ...
  public void testGetPerms() throws IOException {
    String[] perms =
        HTTPRequests.get("api/user/" + TestAccounts.TEST_ACCOUNT.uuid + "/perms", Account.class)
            .perms;
  ...
  public void testGetPerks() throws IOException {
    String[] perks =
        HTTPRequests.get("api/user/" + TestAccounts.TEST_ACCOUNT.uuid + "/perks", Account.class)
            .perks;
  ...
  public void testGetLanguage() throws IOException {
    String language =
        HTTPRequests.get("api/user/" + TestAccounts.TEST_ACCOUNT.uuid + "/language", Account.class)
            .lang;
  ...
  public void testGetMuted() throws IOException {
    boolean muted =
        HTTPRequests.get("api/user/" + TestAccounts.TEST_ACCOUNT.uuid + "/muted", Account.class)
            .muted;
  ...
  public void testGetMutedTime() throws IOException {
    long muteTime =
        HTTPRequests.get("api/user/" + TestAccounts.TEST_ACCOUNT.uuid + "/mute-time", Account.class)
            .mute_time;
  ...
  public void testGetDisplayName() throws IOException {
    String displayName =
        HTTPRequests.get(
                "api/user/" + TestAccounts.TEST_ACCOUNT.uuid + "/display-name", Account.class)
            .display_name;
  ...
  public void testGetDiscordID() throws IOException {
    String discordID =
        HTTPRequests.get(
                "api/user/" + TestAccounts.TEST_ACCOUNT.uuid + "/discord-id", Account.class)
            .discord_id;
  ...
  public void testGetTrackedTime() throws IOException {
    ServerTime[] playTime =
        HTTPRequests.get("api/user/" + TestAccounts.TEST_ACCOUNT.uuid + "/playtime", Account.class)
            .tracked_time;
  ...
  public void testGetWallet() throws IOException {
    BankAccount[] banks =
        HTTPRequests.get("api/user/" + TestAccounts.TEST_ACCOUNT.uuid + "/wallet", Account.class)
            .wallet;
  ...
  public void testGetRewardPoints() throws IOException {
    int points =
        HTTPRequests.get(
                "api/user/" + TestAccounts.TEST_ACCOUNT.uuid + "/reward-points", Account.class)
            .reward_points;
  ...
  public void testSystemPerms() throws IOException {
    String[] systemPerms =
        HTTPRequests.get(
                "api/user/" + TestAccounts.TEST_ACCOUNT.uuid + "/system-perms", Account.class)
            .system_perms;
    assertArrayEquals(
        TestAccounts.TEST_ACCOUNT.system_perms, systemPerms, "System Perms are the same");
  }
  ...
  public void testFullUpdate() throws IOException {
    ...
    int status =
        HTTPRequests.put("api/user/" + TestAccounts.TEST_ACCOUNT.uuid, TestAccounts.TEST_ACCOUNT);
    assertEquals(HttpURLConnection.HTTP_OK, status, "Account has been updated");
    // Make sure its updated
    Account updatedAccount =
        HTTPRequests.get("api/user/" + TestAccounts.TEST_ACCOUNT.uuid, Account.class);
  ...
  public void testPatch() throws IOException {
    ...
    int status =
        HTTPRequests.patch(
            "api/user/" + TestAccounts.TEST_ACCOUNT.uuid + "/language", TestAccounts.TEST_ACCOUNT);
    assertEquals(HttpURLConnection.HTTP_OK, status, "Account has been updated");
    // Make sure its updated
    String updatedLang =
        HTTPRequests.get("api/user/" + TestAccounts.TEST_ACCOUNT.uuid + "/language", Account.class)
            .lang;
    assertEquals(
        TestAccounts.TEST_ACCOUNT.lang, updatedLang, "Language has been updated / changed");
  }
  ...
  public void testDeleteUser() throws IOException {
    Account deletedAccount =
        HTTPRequests.deleteWithReturn(
            "api/user/" + TestAccounts.TEST_ACCOUNT.uuid, null, Account.class);
