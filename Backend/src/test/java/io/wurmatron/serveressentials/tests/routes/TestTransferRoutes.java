...
public class TestTransferRoutes {
    ...
    public void testAddTransferEntry() throws IOException {
        ...
        createdEntry = HTTPRequests.get("api/transfer/" + createdEntry.transfer_id, TransferEntry.class);
        TestTransfers.TEST_ENTRY.transfer_id = createdEntry.transfer_id;
    ...
    public void testGetTransferEntry() throws IOException {
        TransferEntry entry = HTTPRequests.get("api/transfer/" + TestTransfers.TEST_ENTRY.transfer_id, TransferEntry.class);
    ...
    public void testGetUUID() throws IOException {
        TransferEntry entry = HTTPRequests.get("api/transfer/" + TestTransfers.TEST_ENTRY.transfer_id + "/uuid", TransferEntry.class);
    ...
    public void testGetStartTime() throws IOException {
        TransferEntry entry = HTTPRequests.get("api/transfer/" + TestTransfers.TEST_ENTRY.transfer_id + "/start-time", TransferEntry.class);
    ...
    public void testGetItems() throws IOException {
        TransferEntry entry = HTTPRequests.get("api/transfer/" + TestTransfers.TEST_ENTRY.transfer_id + "/items", TransferEntry.class);
    ...
    public void testGetServerID() throws IOException {
        TransferEntry entry = HTTPRequests.get("api/transfer/" + TestTransfers.TEST_ENTRY.transfer_id + "/server-id", TransferEntry.class);
    ...
    public void testUpdateEntry() throws IOException {
        ...
        HTTPRequests.put("api/transfer/" + TestTransfers.TEST_ENTRY.transfer_id, TestTransfers.TEST_ENTRY);
        TransferEntry entry = HTTPRequests.get("api/transfer/" + TestTransfers.TEST_ENTRY.transfer_id, TransferEntry.class);
    ...
    public void testPatchEntry() throws IOException {
        TestTransfers.TEST_ENTRY.items = new ItemWrapper[] {new ItemWrapper("<minecraft:apple>")};
        HTTPRequests.patch("api/transfer/" + TestTransfers.TEST_ENTRY.transfer_id + "/items", TestTransfers.TEST_ENTRY);
        TransferEntry entry = HTTPRequests.get("api/transfer/" + TestTransfers.TEST_ENTRY.transfer_id, TransferEntry.class);
        assertArrayEquals(TestTransfers.TEST_ENTRY.items, entry.items, "Items are the same");
    }
    ...
    public void testDeleteEntry() throws IOException {
        HTTPRequests.deleteWithReturn("api/transfer/" + TestTransfers.TEST_ENTRY.transfer_id, TestTransfers.TEST_ENTRY, TransferEntry.class);
