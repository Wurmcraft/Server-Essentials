...
public class TestCurrencys {
  ...
  public void testAddCurrency() {
    ...
    assertEquals(
        TEST_CURRENCY.global_worth,
        currency.global_worth,
        "Added currency should be the same as the one added");
  }
  ...
  public void testUpdateCurrency() {
    ...
    assertEquals(
        TEST_CURRENCY.display_name, currency.display_name, "Display-Name has been updated");
  ...
  public void testGetCurrencys() {
    ...
    // Remove from cache and try again
    for (Currency currency : currencies) SQLCacheRank.invalidate(currency.display_name);
