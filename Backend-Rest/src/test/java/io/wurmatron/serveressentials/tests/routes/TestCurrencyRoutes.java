...
public class TestCurrencyRoutes {
    ...
    public void testUpdateCurrency() throws IOException {
        ...
        HTTPRequests.put("api/currency/" + TestCurrencys.TEST_CURRENCY.display_name, TestCurrencys.TEST_CURRENCY);
        // Make sure the currency was updated
        Currency currency = HTTPRequests.get("api/currency/" + TestCurrencys.TEST_CURRENCY.display_name, Currency.class);
        assertEquals(TestCurrencys.TEST_CURRENCY, currency, "Currencies are the same");
    }
    ...
    public void testDeleteCurrency() throws IOException {
        Currency deletedCurrency = HTTPRequests.deleteWithReturn("api/currency/" + TestCurrencys.TEST_CURRENCY.display_name, TestCurrencys.TEST_CURRENCY, Currency.class);
