...
public class TestUserRoute {
    ...
    public void testAddUser() throws IOException {
        Account createdAccount = HTTPRequests.postWithReturn("user", TestAccounts.TEST_ACCOUNT, Account.class);
        ...
        createdAccount = HTTPRequests.get("user/" + createdAccount.uuid, Account.class);
        assertNotNull(createdAccount, "Account is not null");
        assertEquals(TestAccounts.TEST_ACCOUNT, createdAccount);
    }
    ...
    public void testGetUsername() throws IOException {
        String username = HTTPRequests.get("user/" + TestAccounts.TEST_ACCOUNT.username + "/username", Account.class).username;
    ...
    public void testGetRanks() throws IOException {
        String[] ranks = HTTPRequests.get("user/" + TestAccounts.TEST_ACCOUNT.uuid + "/rank", Account.class).perks;
    ...
    public void testGetPerms() throws IOException {
        String[] perms = HTTPRequests.get("user/" + TestAccounts.TEST_ACCOUNT.uuid + "/perms", Account.class).perms;
    ...
    public void testGetPerks() throws IOException {
        String[] perks = HTTPRequests.get("user/" + TestAccounts.TEST_ACCOUNT.uuid + "/perks", Account.class).perks;
    ...
    public void testGetLanguage() throws IOException {
        String language = HTTPRequests.get("user/" + TestAccounts.TEST_ACCOUNT.uuid + "/language", Account.class).language;
    ...
    public void testGetMuted() throws IOException {
        boolean muted = HTTPRequests.get("user/" + TestAccounts.TEST_ACCOUNT.uuid + "/muted", Account.class).muted;
    ...
    public void testGetMutedTime() throws IOException {
        long muteTime = HTTPRequests.get("user/" + TestAccounts.TEST_ACCOUNT.uuid + "/mute-time", Account.class).muteTime;
    ...
    public void testGetDisplayName() throws IOException {
        String displayName = HTTPRequests.get("user/" + TestAccounts.TEST_ACCOUNT.uuid + "/display-name", Account.class).displayName;
    ...
    public void testGetDiscordID() throws IOException {
        String discordID = HTTPRequests.get("user/" + TestAccounts.TEST_ACCOUNT.uuid + "/discord-id", Account.class).discordID;
    ...
    public void testGetTrackedTime() throws IOException {
        ServerTime[] playTime = HTTPRequests.get("user/" + TestAccounts.TEST_ACCOUNT.uuid + "/playtime", Account.class).trackedTime;
    ...
    public void testGetWallet() throws IOException {
        BankAccount[] banks = HTTPRequests.get("user/" + TestAccounts.TEST_ACCOUNT.uuid + "/wallet", Account.class).wallet;
    ...
    public void testGetRewardPoints() throws IOException {
        int points = HTTPRequests.get("user/" + TestAccounts.TEST_ACCOUNT.uuid + "/reward-points", Account.class).rewardPoints;
    ...
    public void testSystemPerms() throws IOException {
        String[] systemPerms = HTTPRequests.get("user/" + TestAccounts.TEST_ACCOUNT.uuid + "/system-perms", Account.class).systemPerms;
    ...
    public void testFullUpdate() throws IOException {
        ...
        int status = HTTPRequests.put("user/" + TestAccounts.TEST_ACCOUNT.uuid, TestAccounts.TEST_ACCOUNT);
        assertEquals(HttpURLConnection.HTTP_OK, status, "Account has been updated");
        // Make sure its updated
        Account updatedAccount = HTTPRequests.get("user", Account.class);
    ...
    public void testPatch() throws IOException {
        ...
        int status = HTTPRequests.patch("user/" + TestAccounts.TEST_ACCOUNT.uuid + "/language", TestAccounts.TEST_ACCOUNT);
        assertEquals(HttpURLConnection.HTTP_OK, status, "Account has been updated");
        // Make sure its updated
        String updatedLang = HTTPRequests.get("user", Account.class).language;
