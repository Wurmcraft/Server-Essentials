...
public class TestRankRoutes {
    ...
    public void testAddRank() throws IOException {
        Rank createdRank = HTTPRequests.postWithReturn("rank", TestRanks.TEST_RANK, Rank.class);
        ...
        createdRank = HTTPRequests.get("rank/" + createdRank.name, Rank.class);
        TestRanks.TEST_RANK.rankID = createdRank.rankID;
        assertNotNull(createdRank, "Rank is not null");
    ...
    public void testGetRank() throws IOException {
        Rank rank = HTTPRequests.get("rank/" + TestRanks.TEST_RANK.name, Rank.class);
    ...
    public void testGetName() throws IOException {
        String name = HTTPRequests.get("/rank/" + TestRanks.TEST_RANK.name + "/name", Rank.class).name;
    ...
    public void testGetPerms() throws IOException {
        String[] perms = HTTPRequests.get("/rank/" + TestRanks.TEST_RANK.name + "/permission", Rank.class).permissions;
    ...
    public void testGetInheritance() throws IOException {
        String[] inheritance = HTTPRequests.get("/rank/" + TestRanks.TEST_RANK.name + "/inheritance", Rank.class).inheritance;
    ...
    public void testGetPrefix() throws IOException {
        String prefix = HTTPRequests.get("/rank/" + TestRanks.TEST_RANK.name + "/prefix", Rank.class).prefix;
    ...
    public void testGetPrefixPriority() throws IOException {
        int prefixPriority = HTTPRequests.get("/rank/" + TestRanks.TEST_RANK.name + "/prefix-priority", Rank.class).prefixPriority;
    ...
    public void testGetSuffix() throws IOException {
        String suffix = HTTPRequests.get("/rank/" + TestRanks.TEST_RANK.name + "/suffix", Rank.class).suffix;
    ...
    public void testGetSuffixPriority() throws IOException {
        int suffixPriority = HTTPRequests.get("/rank/" + TestRanks.TEST_RANK.name + "/suffix-priority", Rank.class).suffixPriority;
    ...
    public void testGetColor() throws IOException {
        String color = HTTPRequests.get("/rank/" + TestRanks.TEST_RANK.name + "/color", Rank.class).color;
    ...
    public void testGetColorPriority() throws IOException {
        int colorPriority = HTTPRequests.get("/rank/" + TestRanks.TEST_RANK.name + "/color-priority", Rank.class).colorPriority;
    ...
    public void testRankPatch() throws IOException {
        ...
        int status = HTTPRequests.patch("rank/" + TestRanks.TEST_RANK.name + "/color", TestRanks.TEST_RANK);
        assertEquals(HttpURLConnection.HTTP_OK, status, "Rank has been updated");
        // Make sure its updated
        String color = HTTPRequests.get("rank/" + TestRanks.TEST_RANK.name, Rank.class).color;
    ...
    public void testDeleteRank() throws IOException {
        Rank deletedRank = HTTPRequests.deleteWithReturn("rank/" + TestRanks.TEST_RANK.name, null, Rank.class);
        assertNotNull(deletedRank, "Deleted Rank should be returned");
        // Make sure its deleted
        deletedRank = HTTPRequests.get("rank/" + TestRanks.TEST_RANK.name, Rank.class);
