...
public class Currency {
    ...
    public boolean equals(Object o) {
        ...
        return Double.compare(currency.globalWorth, globalWorth) == 0 && Double.compare(currency.sellWorth, sellWorth) == 0 && Double.compare(currency.tax, tax) == 0 && Objects.equals(displayName, currency.displayName);
    }
