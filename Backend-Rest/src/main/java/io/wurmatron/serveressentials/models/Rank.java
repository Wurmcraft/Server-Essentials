...
public class Rank {
     ...
     */
    public Rank(String name, String[] permissions, String[] inheritance, String prefix, int prefixPriority, String suffix, int suffixPriority, String color, int colorPriority) {
        this.name = name;
