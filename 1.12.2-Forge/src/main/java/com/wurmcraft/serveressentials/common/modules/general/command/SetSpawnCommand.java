...
public class SetSpawnCommand {
    ...
    public void setSpawn(ServerPlayer player, String rank) {
        ...
        File configFile = new File(SAVE_DIR + File.separator + "Modules" + File.separator + "General.json");
        try {
            Files.write(configFile.toPath(), Collections.singleton(GSON.toJson(SECore.moduleConfigs.get("GENERAL"))));
