...
public class HomeCommand {
    ...
    public void defaultHome(ServerPlayer player) {
        Home home = PlayerUtils.getHome(player.local, ((ConfigGeneral) SECore.moduleConfigs.get("GENERAL")).defaultHomeName);
        if (home != null)
            home(player, home);
        else {
    ...
    @Command(args = {CommandArgument.HOME}, usage = {"name"})
    ...
    @Command(args = {CommandArgument.STRING}, usage = "list")
    public void home(ServerPlayer player, String arg) {
        if (arg.equalsIgnoreCase("list") || arg.equalsIgnoreCase("l")) {
            ...
            FMLCommonHandler.instance().getMinecraftServerInstance().commandManager.executeCommand(player.sender, "sethome " + arg);
        } else if (arg.equalsIgnoreCase("delete") || arg.equalsIgnoreCase("del") || arg.equalsIgnoreCase("d") ||
                arg.equalsIgnoreCase("remove") || arg.equalsIgnoreCase("rem") || arg.equalsIgnoreCase("rm") || arg.equalsIgnoreCase("r")) {
            FMLCommonHandler.instance().getMinecraftServerInstance().commandManager.executeCommand(player.sender, "delHome " + arg);
        } else {
    ...
    @Command(args = {CommandArgument.PLAYER, CommandArgument.STRING}, usage = {"player", "name, list"})
