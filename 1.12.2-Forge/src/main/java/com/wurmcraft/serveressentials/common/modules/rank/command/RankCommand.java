...
public class RankCommand {
  ...
  public static void create(ServerPlayer player, String name) {
    ...
    if (SECore.dataLoader.get(DataType.RANK, name) == null) {
      ...
      ChatHelper.send(
          player.sender, player.lang.COMMAND_RANK_CREATED.replaceAll("\\{@NAME@}", name));
      ServerEssentials.LOG.info("Rank " + name + " created!");
    } else {
      ChatHelper.send(
          player.sender, player.lang.COMMAND_RANK_EXISTS.replaceAll("\\{@NAME@}", name));
    }
  }

  @Command(
      args = {CommandArgument.RANK},
      usage = {"rank"},
      isSubCommand = true,
      canConsoleUse = true,
  ...
  @Command(
      ...
      isSubCommand = true,
      canConsoleUse = true,
      subCommandAliases = {"information", "i"})
  public static void info(ServerPlayer player, Rank rank) {
    ChatHelper.send(
        player.sender, player.lang.COMMAND_RANK_INFO_NAME.replaceAll("\\{@NAME@}", rank.name));
    ChatHelper.send(
        player.sender,
        player.lang.COMMAND_RANK_INFO_PERMISSIONS.replaceAll(
            "\\{@PERMS@}", Strings.join(rank.permissions, ", ")));
    ChatHelper.send(
        player.sender,
        player.lang.COMMAND_RANK_INFO_INHERITANCE.replaceAll(
            "\\{@INHERITANCE@}", Strings.join(rank.inheritance, ", ")));
    ChatHelper.send(
        player.sender,
    ...
    ChatHelper.send(
        player.sender,
        player.lang.COMMAND_RANK_INFO_PREFIX_PRIORITY.replaceAll(
            "\\{@NUM@}", rank.prefix_priority + ""));
    ChatHelper.send(
        player.sender,
        player.lang.COMMAND_RANK_INFO_SUFFIX_PRIORITY.replaceAll(
            "\\{@NUM@}", rank.suffix_priority + ""));
    ChatHelper.send(
        player.sender, player.lang.COMMAND_RANK_INFO_COLOR.replaceAll("\\{@COLOR@}", rank.color));
    ChatHelper.send(
        player.sender,
        player.lang.COMMAND_RANK_INFO_COLOR_PRIORITY.replaceAll(
            "\\{@NUM@}", rank.color_priority + ""));
  }
  ...
  @Command(
      ...
      isSubCommand = true,
      canConsoleUse = true)
  public void modify(ServerPlayer player, Rank rank, String action, String type, String data) {
  ...
  public static void add(ServerPlayer player, Rank rank, String type, String data) {
    if (type.equalsIgnoreCase("perm")
        || type.equals("perms")
        || type.equalsIgnoreCase("permission")
        || type.equalsIgnoreCase("permissions")) {
      ...
      ChatHelper.send(
          ...
          player
              .lang
              .COMMAND_RANK_ADD_PERMS
              .replaceAll("\\{@NAME@}", rank.name)
      ...
      if (CommandUtils.isNumber(data)) {
        ...
        ChatHelper.send(
            ...
            player
                .lang
                .COMMAND_RANK_ADD_PREFIX_PRIORITY
                .replaceAll("\\{@NAME@}", rank.name)
                .replaceAll("\\{@NUM@}", data));
        ServerEssentials.LOG.info(
            "Prefix Priority '" + data + "' has been changed for rank '" + rank.name);
      } else {
        ChatHelper.send(player.sender, player.lang.NUMBER_REQUIRED.replaceAll("\\{@NUM@}", data));
      }
      ...
      if (CommandUtils.isNumber(data)) {
        ...
        ChatHelper.send(
            ...
            player
                .lang
                .COMMAND_RANK_ADD_SUFFIX_PRIORITY
                .replaceAll("\\{@NAME@}", rank.name)
                .replaceAll("\\{@NUM@}", data));
        ServerEssentials.LOG.info(
      ...
      if (CommandUtils.isNumber(data)) {
        ...
        ChatHelper.send(
            ...
            player
                .lang
                .COMMAND_RANK_ADD_COLOR_PRIORITY
                .replaceAll("\\{@NAME@}", rank.name)
                .replaceAll("\\{@NUM@}", data));
        ServerEssentials.LOG.info(
      ...
      ChatHelper.send(
          ...
          player
              .lang
              .COMMAND_RANK_ADD_COLOR
              .replaceAll("\\{@NAME@}", rank.name)
              .replaceAll("\\{@COLOR@}", data));
      ServerEssentials.LOG.info("Color '" + data + "' has been set for rank '" + rank.name);
    }
  }
    ...
    if (type.equalsIgnoreCase("perm")
      ...
      ChatHelper.send(
          ...
          player
              ...
              .replaceAll("\\{@NAME@}", rank.name)
              .replaceAll("\\{@INHERITANCE@}", data));
      ServerEssentials.LOG.info("Inheritance '" + data + "' removed from rank '" + rank.name);
    }
  }
}
