...
public class TeleportUtils {
    ...
    public static boolean teleportTo(EntityPlayerMP player, LocalAccount local, Location location, boolean checkTimer) {
        ...
        if (player.dimension == location.dim) {
            ...
            player.connection.sendPacket(new SPacketRespawn(location.dim, serverWorld.getDifficulty(), serverWorld.getWorldInfo().getTerrainType(), player.interactionManager.getGameType()));
