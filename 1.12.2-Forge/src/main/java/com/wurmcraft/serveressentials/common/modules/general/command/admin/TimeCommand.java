...
public class TimeCommand {
  ...
  public void setTime(ServerPlayer player, String time) {
    if (time.equalsIgnoreCase("day")) setTime(player, 1000);
    if (time.equalsIgnoreCase("noon")) setTime(player, 6000);
    if (time.equalsIgnoreCase("dust")) setTime(player, 12000);
    if (time.equalsIgnoreCase("night")) setTime(player, 14000);
  }
