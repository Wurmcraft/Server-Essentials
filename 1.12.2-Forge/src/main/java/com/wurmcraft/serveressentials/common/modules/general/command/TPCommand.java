...
@ModuleCommand(module = "General", name = "Tp", defaultAliases = {"Teleport"})
public class TPCommand {

    @Command(args = {CommandArgument.PLAYER}, usage = "player")
    public void teleportTo(ServerPlayer player, EntityPlayer otherPlayer) {
        TeleportUtils.teleportTo((EntityPlayerMP) player.player, player.local, new Location(otherPlayer.posX, otherPlayer.posY, otherPlayer.posZ, otherPlayer.dimension, player.player.rotationPitch, player.player.rotationYaw));
