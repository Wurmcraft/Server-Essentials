...
public class PlayerDataTrackerEvent {
  ...
  private static final NonBlockingHashMap<String, ScheduledFuture<?>> playerCacheTimeout =
  ...
  public void onPlayerLogout(PlayerEvent.PlayerLoggedOutEvent e) {
    LOG.info(
        "Scheduling unloading for user '{}' ({}) in {}s",
        e.player.getDisplayNameString(),
        e.player.getGameProfile().getId().toString(),
