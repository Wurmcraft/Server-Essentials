...
@ModuleCommand(module = "General", name = "Rename", defaultAliases = {"NickItem", "Name"})
public class ReNameCommand {

    @Command(args = {}, usage = {})
    public void removeName(ServerPlayer player) {
        player.player.getHeldItemMainhand().setStackDisplayName(player.player.getHeldItemMainhand().getItem().getRegistryName().getResourcePath());
    ...
    @Command(args = {CommandArgument.STRING_ARR}, usage = {"name"})
    public void nickItem(ServerPlayer player, String[] name) {
