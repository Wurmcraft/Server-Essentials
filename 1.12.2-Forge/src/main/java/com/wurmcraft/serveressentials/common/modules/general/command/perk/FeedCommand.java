...
@ModuleCommand(module = "General", name = "Feed", defaultAliases = {"Food", "ImTooLazyToEatSoYouDoIt"})
public class FeedCommand {
    ...
    public void feedOther(ServerPlayer player, EntityPlayer otherPlayer) {
        if (RankUtils.hasPermission(player.global, "command.feed.other")) {
            ...
            ChatHelper.send(player.sender, player.lang.COMMAND_FEED_OTHER.replaceAll("\\{@PLAYER@}", otherPlayer.getDisplayNameString()));
