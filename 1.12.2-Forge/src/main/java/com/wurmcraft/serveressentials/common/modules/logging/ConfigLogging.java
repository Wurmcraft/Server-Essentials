...
public class ConfigLogging {
    ...
    public static class Logging {
        ...
        public Logging(boolean blockBreak, boolean blockPlace, boolean interactAir, boolean interactLeft, boolean interactRight, boolean attackBlock, boolean attackEntity, boolean explosion) {
