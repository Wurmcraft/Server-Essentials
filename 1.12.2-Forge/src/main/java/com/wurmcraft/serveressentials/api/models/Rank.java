...
public class Rank {
    ...
    public boolean equals(Object o) {
        ...
        Rank rank = (Rank) o;
        return rankID.equals(rank.rankID)
                && prefixPriority.equals(rank.prefixPriority)
                && suffixPriority.equals(rank.suffixPriority)
                && colorPriority.equals(rank.colorPriority)
