...
public class CommandConfig {
   ...
   * @param minRank minimum rank required to use this command, must also have permission to run the
   *     command
   * @param secure this command can cause serious damage to the server, thus is requires a "trusted"
   *     user
   * @param rankCooldown map of all rank and its designated cooldown, * for all ranks, highest rank
   *     hierarchy for cooldown
   * @param rankDelay map of all rank and its designated delay's, * for all ranks, highest rank
   *     hierarchy for delay
