...
public class Ban {
  ...
  public boolean equals(Object o) {
    ...
    return ban_id == ban.ban_id
        ...
        && Objects.equals(discord_id, ban.discord_id)
        && Objects.equals(banned_by, ban.banned_by)
        && Objects.equals(banned_by_type, ban.banned_by_type)
        && Objects.equals(ban_reason, ban.ban_reason)
        && Objects.equals(ban_type, ban.ban_type)
        && Objects.equals(ban_data, ban.ban_data);
  }

  @Override
  public Ban clone() {
    String json = ServerEssentials.GSON.toJson(this);
    return ServerEssentials.GSON.fromJson(json, Ban.class);
  }
}
