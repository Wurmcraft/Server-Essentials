...
public class LogEntry {
  ...
  public boolean equals(Object o) {
    ...
    return timestamp.equals(logEntry.timestamp)
        ...
        && Objects.equals(server_id, logEntry.server_id)
        && Objects.equals(action_type, logEntry.action_type)
        && Objects.equals(action_data, logEntry.action_data)
  ...
  public LogEntry clone() {
    ...
    return ServerEssentials.GSON.fromJson(json, LogEntry.class);
  }
}
